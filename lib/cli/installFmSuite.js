...
const destPath = args[0] ? args[0] : path.join(__dirname, "..", "..", "src", "filemaker", "fmbond-filemaker-suite.fmp12");
...
// source path is
const sourcePath = path.join(__dirname, "..", "..", "node_modules", "@beezwax", "fmbond-filemaker-suite", "fmbond-filemaker-suite.fmp12");
