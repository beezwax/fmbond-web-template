...
module.exports = class CLI {
  ...
  start ([repoPath]) {
    ...
    const commands = [
      ...
      new FunctionCommand (createFmWebProject, [repoPath], {message: "\x1b[33mCreating Web Project in FileMaker\x1b[0m"}),
      new Command (`cd ${repoPath} && npm run start_silent`, undefined, {message: "\x1b[33mStarting Dev Server\x1b[0m", noWait: true}),
      new FunctionCommand (runFmWebProject, [repoName], {message: "\x1b[33mOpening Web Project in FileMaker\x1b[0m"})
    ];
