...
module.exports = class CLI {
  ...
  start ([repoPath]) {
    ...
    // Run commands
    const commands = [
      new Command (`git clone -b deploy_in_fm --single-branch --depth 1 https://github.com/beezwax/fmbond-web-template`, undefined, {message: `\x1b[33mCreating repo ${repoName}\x1b[0m`}),
